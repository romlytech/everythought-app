    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <p>
          ...
          <a href="http://www.EveryThought.app/">http://www.EveryThought.app</a>
          (the &quot;Website&quot;), and more generally, use any of our services
          (the &quot;Services&quot;, which include the Website), we appreciate
          that you are trusting us with your personal information. We take your
        ...
        <h6 id="information-automatically-collected">
        ...
        <h6
          id="like-many-businesses-we-also-collect-information-through-cookies-and-similar-technologies-"
        >
        ...
        <ul>
          <li>
            ...
            Google or other social account), we use the information you allowed
            us to collect from those third parties to facilitate account
        ...
        <p>
          ...
          or services of our Website. To opt-out of interest-based advertising
        ...
        <p>
          ...
          emails that we send or by contacting us. You will then be removed from
          the marketing email list — however, we may still communicate with you,
          for example to send you service-related emails that are necessary for
